        ...
        <div className="flex flex-col lg:flex-row justify-center items-center">
          <div className="w-full text-center lg:w-7/12 lg:text-left pl-0 lg:pl-20">
            <div className="w-full lg:w-2/3">
              ...
              <a href="mailto:alexander116gm@gmail.com" className="text-pink">
                Mail to Superbluestar
              </a>
              <br />
              <a href="tel:815055326308" className="text-pink">
                Phone to Superbluestar
              </a>
              <br />
              <a href="https://join.skype.com/invite/xlv62Y1CAbcO" className="text-pink">
                Skype to Superbluestar
              </a>
              <br />
              <a href="https://t.me/SuperBluestar" className="text-pink">
                Telegram to Superbluestar
              </a>
